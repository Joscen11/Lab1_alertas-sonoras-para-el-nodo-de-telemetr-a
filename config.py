...
# Se bajaron de 85.0/75.0 (valor original) a 50.0/40.0 para
...
# Modo silencioso: True = no suena nada (para el salon).
...
# CPU: tres pitidos agudos y cortos (urgente, tipo alarma)
SONIDO_CPU = (
    (1000, 120), (37, 80),
    (1000, 120), (37, 80),
    (1000, 120),
...
# Memoria: un solo tono grave y largo (algo "pesado")
SONIDO_MEMORIA = (
    (350, 700),
)

# Trafico: arpegio ascendente rapido (subida de flujo)
SONIDO_TRAFICO = (
    (600, 90),
    (900, 90),
    (1200, 90),
...
# Red desconectada: tres tonos descendentes (se cae)
...
# Red conectada: acorde mayor ascendente (buena noticia)
...
# Red sigue desconectada: golpes graves con pausas (recordatorio)
