...
class ReproductorAlertas:
    ...
    def __init__(self):
        # LABORATORIO - cola acotada: en una rafaga de eventos no crece
        ...
        # LABORATORIO - ultima vez que se ENCOLO cada tipo de alerta,
    ...
    def encolar(self, tipo_alerta):
        ...
        # LABORATORIO - modo silencioso: el evento se sigue registrando
        # en la bitacora (eso ya lo hace nucleo.py antes de llamar
        # aqui); simplemente no se agrega nada a la cola de sonido.
        if config.MODO_SILENCIOSO:
            return

        # LABORATORIO - enfriamiento por tipo de alerta.
    ...
    def _obtener_sonido(self, tipo_alerta):
        ...
        sonidos = {
            ...
            # LABORATORIO - agregado tras la pregunta del profesor sobre
            # si el cargador tambien debia sonar al conectarse/desconectarse.
            "cargador_conectado": config.SONIDO_CARGADOR_CONECTADO,
            "cargador_desconectado": config.SONIDO_CARGADOR_DESCONECTADO,
        }
    ...
    def _reproducir_sonido(self, secuencia):
        ...
        try:
            ...
            # macOS/Linux: se acepta la campana del sistema (F. RECURSOS)
