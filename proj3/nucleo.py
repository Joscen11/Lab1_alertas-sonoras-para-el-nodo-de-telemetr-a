...
# LABORATORIO - paquete nuevo con el reproductor de sonido y el
# detector de conexion de red (ver alertas/reproductor.py y alertas/conexion.py)
...
# ==========================================================================
# LABORATORIO - Componentes de alertas: se crean en iniciar() y se usan
# desde _leer_grupo() y ciclo() para reaccionar a los eventos con sonido.
# ==========================================================================
...
def iniciar():
    ...
    # LABORATORIO - se van a reasignar mas abajo, al crear las instancias
    ...
    # LABORATORIO - arrancan aqui, junto con el resto del nodo, para que
    # esten listos desde el primer ciclo() que se llame.
...
def _leer_grupo(claves):
    ...
    for clave in claves:
        ...
        for nombre, dato in eventos.detectar(
            ...
            # LABORATORIO - se atiende el evento normalmente (bitacora,
            # dashboard) y ademas se revisa si le corresponde un sonido.
            nuevos.append(
                eventos.atender(
                    nombre,
                    dato
            ...
            # LABORATORIO - mapa evento -> tipo de sonido. Los eventos que
            # no aparecen aqui (proceso_pesado, nucleo_saturado, etc.) se
            # siguen registrando en la bitacora, pero no generan sonido.
            sonidos = {
                "cpu_alta": "cpu",
                "ram_alta": "memoria",
                "red_pico": "trafico",
...
def ciclo():
    ...
    # LABORATORIO - la conexion de red se revisa en cada vuelta del ciclo,
    # pero sin bloquear: detectar() solo lee una bandera que un hilo aparte
    # va actualizando (ver alertas/conexion.py).
    if _detector_conexion is not None:

        for nombre, dato in _detector_conexion.detectar():
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # LABORATORIO - REFRESCO_MS esta en milisegundos, time.sleep
            # necesita segundos.
        ...
        # LABORATORIO - se detienen los hilos en segundo plano al salir.
        if _detector_conexion is not None:
