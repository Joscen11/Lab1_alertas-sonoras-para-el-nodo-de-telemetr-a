...
# --------------------------------------------------------------------------
# Conexión de red - LABORATORIO (los 3 manejadores de esta sección son
# nuevos, para los eventos que agrega alertas/conexion.py)
# --------------------------------------------------------------------------
def red_desconectada(dato):
    """Maneja la perdida de conexión de red."""

    return (
        "ALERTA",
        "Conexion de red perdida"
    )


def red_conectada(dato):
    """Maneja la recuperación de conexión de red."""

    return (
        "INFO",
        "Conexion de red recuperada"
    )


def red_sigue_desconectada(dato):
    """Maneja el recordatorio de conexión perdida."""

    return (
        "AVISO",
        "La conexion de red continua desconectada"
    )
...
MANEJADORES = {
    ...
    # LABORATORIO - conexion de red (ver arriba)
