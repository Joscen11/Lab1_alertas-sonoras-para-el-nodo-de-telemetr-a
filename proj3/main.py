...
Uso:
 ...
 python main.py --silencio arranca sin alertas sonoras (LABORATORIO)
"""

import sys

# LABORATORIO - se necesita para poder activar config.MODO_SILENCIOSO
# desde el flag --silencio, mas abajo.
import config
...
def main():
    # LABORATORIO - activa config.MODO_SILENCIOSO para la demo en clase,
    # sin tener que editar config.py cada vez.
